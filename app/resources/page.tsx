...
import { resourcesJsonLd } from '@/lib/seo/resources';
        ...
        <div className={`container ${styles.inner}`}>
          <Reveal className={styles.header}>
            ...
            <p className={styles.subtitle}>
              Explorá nuestras herramientas interactivas para mejorar tu
              práctica de piano.
            </p>
          </Reveal>
            ...
            <Reveal delay={0}>
              ...
              >
                ...
                <p className={styles.cardDescription}>
                  Seguí las notas en la partitura y tocá canciones clásicas
                  usando tu teclado o haciendo clic en las teclas del piano.
                </p>
